          ...
          <ul>
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a href="blog.do">Teams</a></li>
                <li><a href="blog-item.do">Team intro</a></li>
                <li><a href="page-gallery.do">basketball gallery</a></li>
              </ul>
              <!-- END DROPDOWN MENU -->
            </li>
            <li class="dropdown">
              ...
              <!-- BEGIN DROPDOWN MENU -->
              <ul class="dropdown-menu">
                <li><a href="page-404.do">page 400</a>                                  </li>
                <li><a href="page-500.do">page 500</a></li>
                <li><a href="portfolio-item.do">portfolio</a></li>
              </ul>
              <!-- END DROPDOWN MENU -->
            </li>
            ...
            <li><a href="../shop/shop-item.do">MyPage</a></li>                                             
            <!-- BEGIN TOP SEARCH -->
